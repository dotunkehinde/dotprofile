                ...
                <div class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="${contextPath}/index">VISO PATH</a>
                            <i class="brand_network"><small><small>DotProfile</small></small></i>
                        </div>
...
<footer class="w3-center  w3-padding-16" style="background-color:#1C3B47 ">
  <p style="color:#FFFFFF ">Copyright @2023 <a href="#"  target="_blank" class="w3-hover-text-green"> dotunkehinde.com</a></p>
</footer>
